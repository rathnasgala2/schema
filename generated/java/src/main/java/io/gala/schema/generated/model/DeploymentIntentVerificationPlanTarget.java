// Generated from urn:gala:schema:deployment-intent:2.0.0#/$defs/verificationPlanTarget; sourceDesignRevision=a53052955ceb6c1aa10c886289dc832eedfe6de0a00004df07d353ac19c4403a.
...
/** Closed generated record for urn:gala:schema:deployment-intent:2.0.0#/$defs/verificationPlanTarget. */
public record DeploymentIntentVerificationPlanTarget(
        ...
        @JsonProperty("expectedHeaders") List<DeploymentIntentVerificationHeaderExpectation> expectedHeaders,
        ...
        @JsonProperty("recognizedPriorContracts") List<DeploymentIntentRecognizedPriorRouteContract> recognizedPriorContracts,
        @JsonProperty("redirectChain") List<DeploymentIntentExpectedRedirectHop> redirectChain,
    ...
    public DeploymentIntentVerificationPlanTarget {
