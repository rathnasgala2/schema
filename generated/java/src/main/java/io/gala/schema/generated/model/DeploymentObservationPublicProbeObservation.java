// Generated from urn:gala:schema:deployment-observation:2.0.0#/$defs/publicProbeObservation; sourceDesignRevision=a53052955ceb6c1aa10c886289dc832eedfe6de0a00004df07d353ac19c4403a.
...
/** Closed generated record for urn:gala:schema:deployment-observation:2.0.0#/$defs/publicProbeObservation. */
public record DeploymentObservationPublicProbeObservation(
        ...
        @JsonProperty("observedHeaders") List<DeploymentObservationObservedVerificationHeader> observedHeaders,
        ...
        @JsonProperty("precedingProbeEvidenceDigest") String precedingProbeEvidenceDigest,
    ...
    public DeploymentObservationPublicProbeObservation {
        Objects.requireNonNull(attemptNumber, "attemptNumber");
