// Generated from urn:gala:schema:deployment-receipt:2.0.0#/$defs/activationDetectionObservation; sourceDesignRevision=a53052955ceb6c1aa10c886289dc832eedfe6de0a00004df07d353ac19c4403a.
...
/** Closed generated record for urn:gala:schema:deployment-receipt:2.0.0#/$defs/activationDetectionObservation. */
public record DeploymentReceiptActivationDetectionObservation(
        ...
        @JsonProperty("probes") List<DeploymentReceiptActivationDetectionProbe> probes,
        @JsonProperty("profile") String profile,
        @JsonProperty("receivedAt") String receivedAt
) {
    /** Reject a missing required root member before domain use. */
    public DeploymentReceiptActivationDetectionObservation {
