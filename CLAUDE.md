...
only when the runtime package surface changes.
...
performs an isolated emit and byte comparison. Later S0 tasks add contract
generators with the same drift rule. Never hand-edit generated output.
